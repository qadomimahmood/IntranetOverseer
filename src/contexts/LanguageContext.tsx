...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'maintenance.requestTitle': 'Issue Title',
    ...
    // Network
    'network.title': 'Network Manager',
    'network.routerStatus': 'Router Status',
    'network.bandwidthUsage': 'Bandwidth Usage',
    'network.totalUsage': 'Total Usage',
    ...
    'network.limit': 'Limit',
    'network.startTest': 'Start Speed Test',
  ...
  ar: {
    ...
    'maintenance.create': 'إنشاء طلب',
    'maintenance.requestTitle': 'عنوان المشكلة',
    'maintenance.description': 'الوصف',
    'maintenance.priority': 'الأولوية',
    'maintenance.status': 'الحالة',
    'maintenance.assignedTo': 'مسند إلى',
    'maintenance.reportedBy': 'مقدم البلاغ',
    'maintenance.reportedAt': 'تاريخ البلاغ',
    'maintenance.resolvedAt': 'تاريخ الحل',
    'maintenance.status.open': 'مفتوح',
    'maintenance.status.in-progress': 'جاري العمل',
    'maintenance.status.resolved': 'تم الحل',
    'maintenance.status.cancelled': 'ملغى',
    'maintenance.priority.low': 'منخفضة',
    'maintenance.priority.medium': 'متوسطة',
    'maintenance.priority.high': 'عالية',
    'maintenance.priority.urgent': 'طارئة',

    // Network
    'network.title': 'إدارة الشبكة',
    'network.routerStatus': 'حالة الراوتر',
    'network.bandwidthUsage': 'استهلاك البيانات',
    'network.totalUsage': 'الإجمالي',
    'network.speedTest': 'اختبار السرعة',
    'network.online': 'متصل',
    'network.offline': 'غير متصل',
    'network.maintenance': 'صيانة',
    'network.connectedDevices': 'أجهزة متصلة',
    'network.uptime': 'وقت التشغيل',
    'network.download': 'تنزيل',
    'network.upload': 'رفع',
    'network.limit': 'الحد',
    'network.startTest': 'بدء الاختبار',
